			...
			<table class="form-table" cellspacing="0">
				<tbody>
					<tr>
						...
						<td>
							<?php if($all_socials): ?>
								<select class="social_list_field" name="jm_company_custom_field[__options__][socials]" multiple="multiple" style="width: 500px;max-width: 100%;">
									<?php if($selected_arr): ?>
								...
								<input name="jm_company_custom_field[__options__][socials]" type="hidden" value="<?php echo implode(',', $selected_arr ); ?>"/>
